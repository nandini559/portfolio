    ...
    <section className="hero " id="hero">
      <div className="hero__content grid gap-4">
        ...
        <div className="hero__cta text-center flex gap-3 justify-center">
          <a href="#about" className="bg-cyan-500 rounded-full text-white p-4 font-bold">
            Explore My Journey
          </a>
          <a href="#contact" className="btn btn--outline hero__btn border-2 p-5 border-cyan-500 text-cyan-500">
            Get In Touch
          </a>
        </div>
      </div>
