...
const Gmeet = () => {
  ...
  return (<div>
    <div className="grid grid-cols-2 content-start">
      <div className="p-4">
        <div className="ml-4">
          <img className="h-10 w-30" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Google_Meet_text_logo_%282020%29.svg/1200px-Google_Meet_text_logo_%282020%29.svg.png"></img>
        </div>
      ...
      <div className="mt-20">
        <Slider {...settings}>
          <div className="justify-items-center">
            <img className="h-[15rem]" src="//www.gstatic.com/meet/user_edu_get_a_link_light_90698cd7b4ca04d3005c962a3756c42d.svg" alt=""></img>
            <h2 className="text-2xl mt-8">Get a link that you can share</h2>
            <p className="mt-2">
              click new meeting to get a link that you can send to
            </p>
            <p>
              people that you want to meet</p>
          </div>

          <div className="justify-items-center">
            <img className="h-[15rem]" src="https://www.gstatic.com/meet/user_edu_scheduling_light_b352efa017e4f8f1ffda43e847820322.svg" alt=""></img>
          ...
          <div className="justify-items-center">
            <img className="h-[15rem]" src="https://www.gstatic.com/meet/user_edu_safety_light_e04a2bbb449524ef7e49ea36d5f25b65.svg" alt=""></img>
